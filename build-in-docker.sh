...
docker run --rm -it --user $(id -u):$(id -g) -v $(pwd)/../ArenaSDK_Linux_x64:/opt/ArenaSDK_Linux_x64:ro -v $(pwd):/opt/src:ro -v $(pwd)/../artifacts:/opt/artifacts u1804-cpp-dev:latest sh -c "cd /opt/artifacts/build && cmake -G Ninja /opt/src -DCMAKE_INSTALL_PREFIX=/opt/artifacts && cmake --build . --target install && /opt/artifacts/bin/*_smoke_test"
